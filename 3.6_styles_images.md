...
* Donc n'importe quel nouveau bouton placé sous `.buttons` sera stylé même si tu ne veux pas.
...
Maintenant, dans `Button.jsx`, tu fais :
...
✅ Ce fichier CSS module contient :
